        ...
        <div>
          ...
          <div className={style.perkslist}>
            ...
            <div className={style.third}>
              <div className={style.moneyoperkingo} style={{ width: "100px" }}>
                <p className={style.yyx}>
                  <span>
                    <img
                      src={wallet}
                      className={style.xyximg}
                      style={{ width: "15px" }}
                    />
                  </span>
                  1,690,000
          ...
          <div className={style.perkslist}>
            ...
            <div className={style.third}>
              {" "}
              <div className={style.moneyoperkingo} style={{ width: "auto" }}>
                <p className={style.yyx}>
                  <span>
